    ...
    (function() {
        ...
        function tdMouseFuc(e){
            ...
            if(target){
                ...
                if(obj){
                    switch(e.type){
                        case "click": tdClick(obj); break;
                        case "mouseover": addClass(obj, "active"); break;
                        case "mouseout": removeClass(obj, "active"); break;
                    }
                }
            }
        }
        ...
        var startX, changeX, touchFlag, touchObj;
        //触摸事件
        ...
        function touchEndFunc() {
            try {
                var table=document.getElementById("calendar").getElementsByTagName("table")[0];
                ...
                if (changeX < -tdWidth/2 && touchFlag) {
                    ...
                    if(touchObj){
                        var obj=null;
                        if(touchObj.nodeName.toLowerCase()=="div"){
                            obj=touchObj;
                        }
                        else if(touchObj.nodeName.toLowerCase()=="span"){
                            obj=touchObj.parentNode;
                        }
                        else if(touchObj.nodeName.toLowerCase()=="td"){
                            obj=touchObj.children[0];
                        }
                        if(obj){
                            obj.click();
                        }
        ...
        var table= cal.getElementsByTagName("table")[0];
        for (var i = 0; i < aSel.length; i++) {
            aSel[i].addEventListener("change" , updateDate, false);
        }
